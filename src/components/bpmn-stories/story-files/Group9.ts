import dummyBpmnUrl from "/bpmn-stories/group9/dummy.bpmn?url";
import dummyDmnUrl from "/bpmn-stories/group9/dummy.dmn?url";
import dummyFormUrl from "/bpmn-stories/group9/dummy.form?url";

export const Group9: bpmnStory[] = [
  {
    id: "group9id",
    title: "Group9 - Title",
    description: "Group9 - Description",
    participants: [
      {
        id: "1",
        protagonist: true,

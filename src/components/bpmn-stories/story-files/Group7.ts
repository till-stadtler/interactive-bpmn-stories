import dummyBpmnUrl from "/bpmn-stories/group7/dummy.bpmn?url";
import dummyDmnUrl from "/bpmn-stories/group7/dummy.dmn?url";
import dummyFormUrl from "/bpmn-stories/group7/dummy.form?url";

export const Group7: bpmnStory[] = [
  {
    id: "group7id",
    title: "Group7 - Title",
    description: "Group7 - Description",
    participants: [
      {
        id: "1",
        protagonist: true,

import dummyBpmnUrl from "/bpmn-stories/group13/dummy.bpmn?url";
import dummyDmnUrl from "/bpmn-stories/group13/dummy.dmn?url";
import dummyFormUrl from "/bpmn-stories/group13/dummy.form?url";

export const Group13: bpmnStory[] = [
  {
    id: "group13id",
    title: "Group13 - Title",
    description: "Group13 - Description",
    participants: [
      {
        id: "1",
        protagonist: true,

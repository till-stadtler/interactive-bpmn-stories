import dummyBpmnUrl from "/bpmn-stories/group8/dummy.bpmn?url";
import dummyDmnUrl from "/bpmn-stories/group8/dummy.dmn?url";
import dummyFormUrl from "/bpmn-stories/group8/dummy.form?url";

export const Group8: bpmnStory[] = [
  {
    id: "group8id",
    title: "Group8 - Title",
    description: "Group8 - Description",
    participants: [
      {
        id: "1",
        protagonist: true,

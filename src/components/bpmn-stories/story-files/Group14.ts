import dummyBpmnUrl from "/bpmn-stories/group14/dummy.bpmn?url";
import dummyDmnUrl from "/bpmn-stories/group14/dummy.dmn?url";
import dummyFormUrl from "/bpmn-stories/group14/dummy.form?url";

export const Group14: bpmnStory[] = [
  {
    id: "group14id",
    title: "Group14 - Title",
    description: "Group14 - Description",
    participants: [
      {
        id: "1",
        protagonist: true,

import dummyBpmnUrl from "/bpmn-stories/group6/dummy.bpmn?url";
import dummyDmnUrl from "/bpmn-stories/group6/dummy.dmn?url";
import dummyFormUrl from "/bpmn-stories/group6/dummy.form?url";

export const Group6: bpmnStory[] = [
  {
    id: "group6id",
    title: "Group6 - Title",
    description: "Group6 - Description",
    participants: [
      {
        id: "1",
        protagonist: true,

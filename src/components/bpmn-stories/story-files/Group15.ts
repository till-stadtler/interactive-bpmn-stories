import dummyBpmnUrl from "/bpmn-stories/group15/dummy.bpmn?url";
import dummyDmnUrl from "/bpmn-stories/group15/dummy.dmn?url";
import dummyFormUrl from "/bpmn-stories/group15/dummy.form?url";

export const Group15: bpmnStory[] = [
  {
    id: "group15id",
    title: "Group15 - Title",
    description: "Group15 - Description",
    participants: [
      {
        id: "1",
        protagonist: true,

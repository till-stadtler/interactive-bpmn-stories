import dummyBpmnUrl from "/bpmn-stories/group11/dummy.bpmn?url";
import dummyDmnUrl from "/bpmn-stories/group11/dummy.dmn?url";
import dummyFormUrl from "/bpmn-stories/group11/dummy.form?url";

export const Group11: bpmnStory[] = [
  {
    id: "group11id",
    title: "Group11 - Title",
    description: "Group11 - Description",
    participants: [
      {
        id: "1",
        protagonist: true,

import dummyBpmnUrl from "/bpmn-stories/group10/dummy.bpmn?url";
import dummyDmnUrl from "/bpmn-stories/group10/dummy.dmn?url";
import dummyFormUrl from "/bpmn-stories/group10/dummy.form?url";

export const Group10: bpmnStory[] = [
  {
    id: "group10id",
    title: "Group10 - Title",
    description: "Group10 - Description",
    participants: [
      {
        id: "1",
        protagonist: true,
